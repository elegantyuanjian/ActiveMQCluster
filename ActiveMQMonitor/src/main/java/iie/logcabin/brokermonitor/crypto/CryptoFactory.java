package iie.logcabin.brokermonitor.crypto;
...
public class CryptoFactory {
	...
	public CryptoFactory(String serverType)
	{
		...
		if(serverType.equals(ServerType.CONTROLLERSERVER))
		{
			keyValue = configReader.getClusterControllerConfig().getChannelKey();
		}
		else
		{
			log.error("没有对应的服务类型");
